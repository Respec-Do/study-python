...
# 번호, 아이디, 비밀번호, 이름
# 번호는 자동으로 1씩 증가한다.
# 관리자로 회원가입 시, 아이디 앞에 'admin_'을 자동으로 붙여준다(class_method)
...
class Member:
    ...
    def __init__(self, Id, password, name):
        ...
        self.name = name
        self.user_number = Member.__user_number
        Member.__user_number += 1

    @staticmethod
    def get_number():
        return Member.__user_number
...
member = Member('kir', 1234, name='도강현')
member1 = Member.admin('dor', 1234, name='han')
print(member1.Id)
