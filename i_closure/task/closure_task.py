...
#
#     return {'insert' : insert, 'update' : update, 'delete' : delete, 'select' : select, 'select_all': select_all}
#
# user_service = set_user()
# user_service.get('insert')('han')
# print(user_service.get('select')(6))
# print(user_service.get('select_all')())
# user_service.get('delete')(3)
# print(user_service.get('select_all')())
# user_service.get('update')(number = 5, name ='richard')
# print(user_service.get('select_all')())
...
def post_set():
    ...
    return {'insert' : insert, 'update' : update, 'delete' : delete, 'select_all' : select_all, 'read' : read}

post_service = post_set()
print(post_service.get('select_all')())
post_service.get('insert')(title = '테스트 제목6', content = '테스트 내용 6', file = 'test')
print(post_service.get('select_all')())
post_service.get('delete')(5)
print(post_service.get('select_all')())
post_service.get('read')(6)
print(post_service.get('select_all')())
post_service.get('update')(number = 6, title = '파이썬', content = 'Hello World', file = 'None')
print(post_service.get('select_all')())
